...
class BaseFileHelper
{
     ...
     * and language code "sw", the localized file will be looked for as
     * "path/to/sw/view.php". If the file is not found, it will try a fallback with just a language code that is
